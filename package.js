Package.describe({
  name: 'bither:elements',
  summary: 'Basic elements for Dapps',
  version: '0.7.17',
  git: 'http://github.com/bitherhq/meteor-package-elements'
});
...
Package.onUse(function(api) {
  ...
  api.use('bither:web3@0.15.2', 'client');
  api.use('bither:tools@0.4.0', 'client');
  ...
  api.imply(['frozeman:template-var','bither:tools'], 'client');
